...
public class Firma {
    ...
    public void menu(){
        ...
        while(menu != 0){
            ...
            switch(menu){
                case 1: if (dodawaniePracownika()) System.out.println("Gotowe!");
                        else System.out.println("Wystąpił błąd!");
                        break;
                        
                case 2: if (usuwaniePracownika()) System.out.println("Gotowe!");
                        else System.out.println("Wystąpił błąd!");
                        break;
                        
                case 3: if (pokazListe()) System.out.println("Gotowe!");
                        else System.out.println("Wystąpił błąd!");
                        break;
